...
public class PlayerController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        damageable.playerDied.AddListener(HandlePlayerDeath);
    ...
    {
        // Add any additional logic you need before loading the Game Over scene
        // For example, you might want to play an animation or display a game over UI.
        // Then, load the Game Over scene:

        SceneManager.LoadScene("LoseScene");  // Replace "GameOverScene" with your actual scene name
    }
